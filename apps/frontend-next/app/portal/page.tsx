              ...
              <div className="space-y-3 text-center md:text-left">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <button 
                    ...
                    className="srf-btn-primary px-12 py-6 font-black text-xl shadow-[0_20px_40px_rgba(255,106,42,0.3)] hover:shadow-orange-500/50 active:scale-95 flex items-center justify-center gap-3"
                  >
                    {loading ? (
                ...
                <div className="space-y-10">
                   ...
                   <div className="flex gap-6 items-start">
                      ...
                      <div>
                         ...
                         <p className="text-slate-300 mt-2 text-base leading-relaxed font-medium">
