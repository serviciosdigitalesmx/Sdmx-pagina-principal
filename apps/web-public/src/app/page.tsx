...
export default function Home() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(180,83,9,0.14),_transparent_22%),radial-gradient(circle_at_80%_10%,_rgba(180,83,9,0.08),_transparent_24%),linear-gradient(180deg,#050505_0%,#0f0f10_46%,#141210_100%)] text-zinc-100">
      <section className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-4 sm:px-6 lg:px-8">
        <header className="rounded-[2rem] border border-amber-700/15 bg-[linear-gradient(180deg,rgba(14,13,12,0.96),rgba(14,13,12,0.90))] px-5 py-4 shadow-[0_20px_70px_rgba(120,53,15,0.18)] backdrop-blur-xl">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-amber-700/20 bg-[linear-gradient(180deg,rgba(124,45,18,0.22),rgba(15,23,42,0.96))] text-sm font-black text-amber-50 shadow-[0_20px_60px_rgba(180,83,9,0.10)]">
                FX
              </div>
              <div>
            ...
            <nav className="flex flex-wrap items-center gap-2 text-sm text-zinc-300">
              <a className="rounded-full border border-stone-700 px-4 py-2 transition hover:border-amber-700/30 hover:bg-white/4" href="#producto">
                Producto
              </a>
              <a className="rounded-full border border-stone-700 px-4 py-2 transition hover:border-amber-700/30 hover:bg-white/4" href="#seguridad">
                Seguridad
              </a>
              <a className="rounded-full border border-stone-700 px-4 py-2 transition hover:border-amber-700/30 hover:bg-white/4" href="#precios">
                Precios
              </a>
              <a className="rounded-full border border-stone-700 px-4 py-2 transition hover:border-amber-700/30 hover:bg-white/4" href="#contacto">
                Contacto
              </a>
              <Link
                className="rounded-full border border-amber-700/30 bg-amber-500/10 px-5 py-3 font-semibold text-amber-50 transition hover:border-amber-300/40 hover:bg-amber-500/15"
                href="/onboarding"
              >
                Crear mi tenant
              </Link>
        ...
        <section className="rounded-[2.5rem] border border-amber-700/15 bg-[linear-gradient(180deg,rgba(16,14,12,0.96),rgba(22,18,14,0.98))] px-5 py-8 shadow-[0_30px_120px_rgba(120,53,15,0.16)] lg:px-8 lg:py-12">
          <div className="mx-auto max-w-5xl text-center">
            <div className="mx-auto inline-flex rounded-full border border-amber-700/20 bg-amber-500/10 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.3em] text-amber-50">
            ...
            <h1 className="mx-auto mt-6 max-w-4xl text-balance text-5xl font-black tracking-[-0.07em] text-stone-50 sm:text-6xl lg:text-7xl">
              Convierte tu taller en una operación premium con <span className="text-amber-100">{productName}</span>.
            </h1>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Link
                className="rounded-full bg-amber-50 px-6 py-3 text-sm font-semibold text-zinc-950 transition hover:bg-amber-100"
                href="/onboarding"
              >
                Crear mi tenant
              </Link>
              <Link
                className="rounded-full border border-stone-700 bg-white/4 px-6 py-3 text-sm font-semibold text-zinc-100 transition hover:border-amber-700/30 hover:bg-white/10"
                href={demoHref}
              >
                Ver demo en vivo
              </Link>
            ...
            {metrics.map((metric) => (
                <article key={metric.label} className="rounded-[1.5rem] border border-stone-700/70 bg-white/4 p-5 backdrop-blur">
                  <p className="text-3xl font-black tracking-tight text-stone-50">{metric.value}</p>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-2">
              {["Recepción", "Tracking", "Inventario", "WhatsApp", "Portal cliente", "PDF", "Privacidad", "Marca blanca"].map((tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-stone-700 bg-white/4 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-zinc-200"
                >
                  {tag}
                </span>
              ))}
        ...
        <section className="grid gap-4 lg:grid-cols-4" id="producto">
          {coreCards.map((card) => (
            <article key={card.title} className="rounded-[1.75rem] border border-stone-700/70 bg-zinc-950/85 p-5 shadow-[0_18px_70px_rgba(0,0,0,0.28)] transition hover:-translate-y-0.5 hover:border-amber-700/30">
              <p className="text-[10px] font-semibold uppercase tracking-[0.3em] text-amber-100">{card.eyebrow}</p>
              <h2 className="mt-3 text-xl font-bold text-stone-50">{card.title}</h2>
        ...
        <section
          id="app-movil"
          className="grid gap-4 rounded-[2.5rem] border border-stone-700/70 bg-[linear-gradient(180deg,rgba(9,9,11,0.94),rgba(15,17,21,0.98))] px-5 py-8 lg:px-8"
        >
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-amber-100">App móvil</p>
              <h2 className="mt-3 text-4xl font-black tracking-[-0.05em] text-stone-50 sm:text-5xl">FIXI también va en tu celular.</h2>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center rounded-full bg-amber-50 px-6 py-3 text-sm font-semibold text-zinc-950 transition hover:bg-amber-100"
            >
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {mobileAppCards.map((card) => (
              <article key={card.title} className="rounded-[1.5rem] border border-stone-700 bg-white/4 p-5">
        ...
        <section className="grid gap-4 rounded-[2.5rem] border border-stone-700/70 bg-zinc-950/85 px-5 py-8 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-amber-100">Capacidades</p>
            <h2 className="mt-3 text-4xl font-black tracking-[-0.05em] text-stone-50 sm:text-5xl">Todo lo que tu taller usa en un solo lugar.</h2>
            <p className="mt-4 text-base leading-8 text-zinc-300">
        ...
        <section className="grid gap-4 rounded-[2.5rem] border border-stone-700/70 bg-[linear-gradient(180deg,rgba(9,9,11,0.94),rgba(15,17,21,0.98))] px-5 py-8 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-amber-100">Cómo funciona</p>
            <h2 className="mt-3 text-4xl font-black tracking-[-0.05em] text-stone-50 sm:text-5xl">Tres pasos para empezar sin fricción.</h2>
            <p className="mt-4 text-base leading-8 text-zinc-300">
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            {howItWorks.map((item) => (
              <article key={item.step} className="rounded-[1.5rem] border border-stone-700 bg-white/4 p-5">
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-amber-100">{item.step}</p>
                <h3 className="mt-3 text-xl font-semibold text-stone-50">{item.title}</h3>
        ...
        <section className="grid gap-4 rounded-[2.5rem] border border-stone-700/70 bg-[linear-gradient(180deg,rgba(9,9,11,0.92),rgba(15,17,21,0.98))] px-5 py-8 lg:px-8">
          <div className="max-w-3xl">
              <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-amber-100">Adopción</p>
            <h2 className="mt-3 text-4xl font-black tracking-[-0.05em] text-stone-50 sm:text-5xl">Alcance visible de FIXI.</h2>
            <p className="mt-4 text-base leading-8 text-zinc-300">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {proofMetrics.map((metric) => (
              <article key={metric.label} className="rounded-[1.5rem] border border-stone-700 bg-white/4 p-5">
                <p className="text-3xl font-black tracking-tight text-stone-50">{metric.value}</p>
                <p className="mt-2 text-xs font-semibold uppercase tracking-[0.22em] text-zinc-400">{metric.label}</p>
              </article>
            ))}
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {socialProofTestimonials.map((testimonial) => (
              <article key={`${testimonial.name}-${testimonial.company}`} className="rounded-[1.5rem] border border-stone-700 bg-white/4 p-5">
                <p className="text-sm leading-7 text-zinc-300">
                  “Seguimos cada orden y el cliente revisa su estado sin llamadas innecesarias.”
                </p>
                <div className="mt-4">
                  <p className="font-semibold text-stone-50">{testimonial.name}</p>
        ...
        <section id="seguridad" className="grid gap-4 rounded-[2.5rem] border border-stone-700/70 bg-[linear-gradient(180deg,rgba(9,9,11,0.92),rgba(15,17,21,0.98))] px-5 py-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-amber-100">Confianza técnica</p>
            <h2 className="mt-3 text-4xl font-black tracking-[-0.05em] text-stone-50 sm:text-5xl">Arquitectura visible.</h2>
          ...
          <div className="grid gap-4">
            {trustBlocks.map((block) => (
              <article key={block.title} className="rounded-[1.5rem] border border-stone-700 bg-white/4 p-5">
                <h3 className="text-lg font-semibold text-stone-50">{block.title}</h3>
                <p className="mt-2 text-sm leading-7 text-zinc-400">{block.copy}</p>
              </article>
            ))}
            <div className="rounded-[1.5rem] border border-amber-700/20 bg-amber-500/10 p-5 text-sm leading-7 text-slate-50">
              <span className="font-semibold text-amber-50">Contrato de seguridad:</span> cada taller ve sólo su información, su branding
              y su operación.
            </div>
          </div>
        </section>

        <section id="precios" className="space-y-6 rounded-[2.5rem] border border-stone-700/70 bg-zinc-950/85 px-5 py-8 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-amber-100">Planes</p>
            <h2 className="mt-3 text-4xl font-black tracking-[-0.05em] text-stone-50 sm:text-5xl">Planes claros para arrancar y escalar.</h2>
            <p className="mt-4 text-base leading-8 text-zinc-300">
            ...
            {planCopy.map((plan) => (
              <article
                ...
                className={[
                  ...
                  plan.highlight
                    ? "border-amber-700/30 bg-[linear-gradient(180deg,rgba(194,138,55,0.12),rgba(9,9,11,1))] ring-1 ring-stone-400/20"
                    : "border-stone-700 bg-white/4",
                ].join(" ")}
              >
                {plan.highlight ? (
                  <div className="mb-4 inline-flex rounded-full border border-amber-700/30 bg-amber-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-amber-50">
                    Más popular
                  </div>
                ) : null}
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-zinc-400">{plan.name}</p>
                <p className="mt-3 text-4xl font-black tracking-tight text-stone-50">{plan.price}</p>
                ...
                <div className="mt-5 rounded-2xl border border-stone-700 bg-white/4 p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.22em] text-amber-100">Incluye conceptos</p>
                ...
                <Link
                  ...
                  className={[
                    ...
                    plan.highlight
                      ? "bg-amber-50 text-zinc-950 hover:bg-amber-100"
                      : "border border-stone-700 bg-white/4 text-zinc-100 hover:border-amber-700/30 hover:bg-white/10",
                  ].join(" ")}
                >
        ...
        <footer
          id="contacto"
          className="grid gap-6 rounded-[2.5rem] border border-stone-700/70 bg-[linear-gradient(180deg,rgba(15,17,21,0.92),rgba(9,9,11,0.98))] px-5 py-8 lg:grid-cols-[1fr_0.95fr] lg:px-8"
        >
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-amber-100">Contacto</p>
            <h2 className="mt-3 text-4xl font-black tracking-[-0.05em] text-stone-50">Contacta a FIXI.</h2>
            <p className="mt-4 max-w-2xl text-base leading-8 text-zinc-300">
              Déjanos tus datos para arrancar una demo o valida el producto con el recorrido público.
            </p>
          </div>

          <div className="rounded-[1.75rem] border border-stone-700 bg-white/4 p-5">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <a href={contactEmailHref} className="rounded-full bg-amber-50 px-5 py-3 text-sm font-semibold text-zinc-950 transition hover:bg-amber-100">
                Escribir por email
              </a>
              <a href={contactPhoneHref ?? whatsappHref ?? "#contacto"} className="rounded-full border border-stone-700 px-5 py-3 text-sm font-semibold text-zinc-100 transition hover:border-amber-700/30 hover:bg-white/10">
